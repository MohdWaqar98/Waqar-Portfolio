            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:mohdwaqar695@gmail.com" className="hover:text-neon-blue hover-target">mohdwaqar695@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+91 9625219226" className="hover:text-neon-blue hover-target">+91 9625219226</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="https://www.linkedin.com/in/mohdwaqar98/" target="_blank" rel="noopener noreferrer" className="hover:text-neon-blue hover-target">linkedin.com/in/mohdwaqar98</a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href="https://github.com/MohdWaqar98" target="_blank" rel="noopener noreferrer" className="hover:text-neon-blue hover-target">github.com/MohdWaqar98</a>
                </div>
              </div>
            </div>
          </div>
